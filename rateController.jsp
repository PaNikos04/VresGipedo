...
int fid = Integer.parseInt(request.getParameter("am"));

PaymentDao paydao = new PaymentDao();
int idCli = paydao.getIdClient(client.getUsername());

Rating rating = new Rating(idCli, fid, myrating, mycomment);
RatingDao ratdao = new RatingDao();
int flag = ratdao.getExistRating(idCli, fid);


if(flag == 6){
  ratdao.setRating(rating);
} else{
  ratdao.createRating(rating);
}
...
<link rel="stylesheet" href="css/fontawesome.all.css">
	...
	<body>	
      ...
      <div class="alert alert-success text-center" role="alert">Επιτυχής αξιολόγηση!</div>	
      <!-- FIX GIF IN CENTER -->
        <h1 style="text-align: center;">Ευχαριστούμε που μοιραστήκατε την γνώμη σας!</h1>
		</div>
		<!-- /container -->
